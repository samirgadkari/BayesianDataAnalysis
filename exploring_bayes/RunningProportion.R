...
# Note that in the above line, the prob sequence has to match
# the notion of heads or tails. Since we're saying heads = 1 and tails = 0,
# we specify probability of tails as the 1st element of the sequence,
# and the probability of heads as the second.
